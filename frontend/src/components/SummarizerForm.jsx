                    ...
                    <div className="flex w-full">
                        ...
                        <div className="relative">
                            <select
                                ...
                                disabled={isLoading}
                                className="h-full pl-4 pr-10 bg-gray-700 text-white text-sm focus:outline-none cursor-pointer appearance-none border-l border-r border-gray-600 hover:bg-gray-600 transition-colors"
